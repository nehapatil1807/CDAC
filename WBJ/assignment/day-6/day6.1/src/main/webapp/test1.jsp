...
<body>
	...
	<h5>Session ID - ${pageContext.session.id}</h5> <%-- not blank --%>  
	<%-- cookie is map of cookie object --%>
	<%-- cookie.get("JSESSIONID").getValue() --%>
	<h5>Cookie JSESSIONID - ${cookie.JSESSIONID.value}</h5> <%-- blank --%>
